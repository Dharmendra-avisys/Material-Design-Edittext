...
import com.avisys.allinone.firestore.MyFirestoreActivity;
...
public class SplashScreenActivity extends AppCompatActivity implements View.OnClickListener {
    private TextView roomDatabase,lifeCycle,pagination,touchGameView,
            ...
            locationService,wifi,mediaPlayer,chekNetwork,firestore;
    ...
    private void init(){
        ...
        firestore.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.network:
                ...
                break;
            case R.id.firestore:
                startActivity(new Intent(this, MyFirestoreActivity.class));
                break;
            default:
                Toast.makeText(SplashScreenActivity.this, "Default activity", Toast.LENGTH_SHORT).show();
                break;
        }
    };
